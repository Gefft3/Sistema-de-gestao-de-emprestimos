...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Fev-2022 às 17:05
...
(66, 17, 'name', 'text', 'Nome Completo', 1, 1, 1, 1, 1, 1, '{}', 2),
(67, 17, 'academic_record', 'text', 'Registro Acadêmico', 1, 1, 1, 1, 1, 1, '{}', 5),
(68, 17, 'created_at', 'timestamp', 'Criado em', 0, 0, 1, 0, 0, 0, '{}', 14),
(69, 17, 'updated_at', 'timestamp', 'Atualizado em', 0, 0, 1, 0, 0, 0, '{}', 15),
(70, 17, 'deleted_at', 'timestamp', 'Deleted At', 0, 0, 0, 0, 0, 0, '{}', 16),
...
(82, 17, 'student_belongsto_user_relationship', 'relationship', 'Usuário', 0, 0, 1, 1, 1, 0, '{\"model\":\"App\\\\Models\\\\User\",\"table\":\"users\",\"type\":\"belongsTo\",\"column\":\"user_id\",\"key\":\"id\",\"label\":\"name\",\"pivot_table\":\"categories\",\"pivot\":\"0\",\"taggable\":\"0\"}', 3),
(83, 17, 'user_id', 'text', 'User Id', 1, 0, 0, 0, 0, 0, '{}', 9),
...
(107, 17, 'cpf', 'text', 'CPF', 1, 0, 1, 1, 1, 0, '{}', 4),
(108, 17, 'course_period', 'select_dropdown', 'Semestre em curso', 1, 1, 1, 1, 1, 1, '{\"default\":\"0\",\"options\":{\"0\":\"Selecione um semestre\",\"1\":\"Primeiro semestre\",\"2\":\"Segundo semestre\",\"3\":\"Terceiro semestre\",\"4\":\"Quarto semestre\",\"5\":\"Quinto semestre\",\"6\":\"Sexto semestre\",\"7\":\"S\\u00e9timo semestre\",\"8\":\"Oitavo semestre\",\"9\":\"Nono semestre\",\"10\":\"D\\u00e9cimo semestre\"}}', 7),
(109, 17, 'cell_number', 'text', 'Celular do estudante', 1, 1, 1, 1, 1, 1, '{}', 8),
(110, 17, 'name_responsible', 'text', 'Nome Completo do responsável', 0, 0, 1, 1, 1, 1, '{}', 10),
(111, 17, 'cpf_responsible', 'text', 'CPF do responsável', 0, 0, 1, 1, 1, 1, '{}', 11),
(112, 17, 'cell_number_responsible', 'text', 'Celular do responsável', 0, 0, 1, 1, 1, 1, '{}', 12),
(113, 17, 'address', 'text', 'Endereço', 1, 0, 1, 1, 1, 1, '{}', 13),
(114, 17, 'course', 'select_dropdown', 'Curso', 1, 1, 1, 1, 1, 1, '{\"default\":\"0\",\"options\":{\"0\":\"Selecione um curso\",\"1\":\"T\\u00e9cnico em inform\\u00e1tica\",\"2\":\"T\\u00e9cnico em edifica\\u00e7\\u00f5es\"}}', 6);
...
(17, 'students', 'students', 'Estudante', 'Estudantes', 'voyager-study', 'App\\Models\\Student', NULL, NULL, NULL, 1, 0, '{\"order_column\":null,\"order_display_column\":null,\"order_direction\":\"asc\",\"default_search_key\":null,\"scope\":null}', '2021-08-26 07:51:30', '2022-02-14 20:01:57'),
...
(25, 'Placa Uno R3 + Cabo USB para Arduino Solicitado por Cassia Simão', '2022-02-26', NULL, '3', NULL, 'Nada a ser observado.', '2022-02-10 14:19:10', '2022-02-10 14:19:10', NULL, 33);
...
(33, '<p>Para cumprimento do TCC de prototipagem.</p>', '<p>Justificativa aceit&aacute;vel para o empr&eacute;stimo.</p>', 4, 5, 2, '2022-02-10 13:58:58', '2022-02-10 14:19:10', NULL),
(34, '<p>Para jogar muito.</p>', '<p>Justificativa n&atilde;o se encaixa na proposta educacional.</p>', 3, 4, 2, '2022-02-10 14:09:32', '2022-02-10 14:10:12', NULL);
...
CREATE TABLE `students` (
  ...
  `course_period` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `cell_number` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `name_responsible` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cpf_responsible` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cell_number_responsible` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 1, 'Admin', 'admin@admin.com', 'users/default.png', NULL, '$2y$10$zDq4deUVaL4IhZEPM1K.T.i4f5ZSEBwG18X1ITVFzzwMVkltdxA/a', NULL, NULL, '5jXhwfTI31KkEuh0x2YbLYgVZENC6zhOj4O28wUAUPmAgOOu0gTULhfyt0qE', '{\"locale\":\"pt\"}', '2021-12-07 23:32:01', '2021-12-07 23:32:01'),
(2, 2, 'Ana Maria', 'user@user.com', 'users/default.png', NULL, '$2y$10$eM9maHo./vBBzihi7WdJHuvGtiPzCtFf7/2aAHBv5ik6W08OUvhaG', NULL, NULL, NULL, '{\"locale\":\"pt\"}', '2021-12-11 00:43:57', '2022-02-10 14:00:07'),
(3, 3, 'Cassia Simão', 'gestor@gestor.com', 'users/default.png', NULL, '$2y$10$ElnL3f/vpysVq1nVceijd.7T76PLIarIc5DJZEXpYvWhTY8nR3Z5.', NULL, NULL, NULL, '{\"locale\":\"pt\"}', '2022-02-08 00:52:42', '2022-02-08 00:52:42'),
(4, 2, 'Ana Farias', 'ana@ana.com', 'users/default.png', NULL, '$2y$10$2qr09Z8J9omopdQ7WmfDjuVffskHzpXrsbQMljmPHMucYhE8x2s5S', NULL, NULL, NULL, '{\"locale\":\"pt\"}', '2022-02-14 11:53:04', '2022-02-14 11:53:04'),
(5, 2, 'Antonio Pache', 'pache@pache.com', 'users/default.png', NULL, '$2y$10$Y5IKKiBlHjk9FWEdsEBPHekBQoNNQKGf8LIE3AJgwoOCpAiIHTav6', NULL, NULL, NULL, '{\"locale\":\"pt\"}', '2022-02-14 19:56:01', '2022-02-14 19:56:01');
